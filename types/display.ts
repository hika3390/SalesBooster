...
export type DataRefreshInterval = 'SECONDS_10' | 'SECONDS_30' | 'MINUTES_1' | 'MINUTES_5' | 'MINUTES_15' | 'MINUTES_30';
...
/** データ更新間隔の選択肢 */
export const DATA_REFRESH_INTERVAL_OPTIONS: { value: DataRefreshInterval; label: string }[] = [
