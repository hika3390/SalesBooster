...
export default function DisplayInfoSection({ config, onConfigChange }: DisplayInfoSectionProps) {
  return (
      ...
      <div className="space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
          ...
          <input
            ...
            onChange={(e) => onConfigChange((prev) => ({ ...prev, teamName: e.target.value }))}
            placeholder="例: 営業1課"
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
          ...
          <input
            ...
            onChange={(e) => onConfigChange((prev) => ({ ...prev, companyLogoUrl: e.target.value }))}
