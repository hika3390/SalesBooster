          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3 pt-2">
              <div className="flex items-center text-blue-100">
                <svg className="w-5 h-5 mr-3 text-blue-300 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {['会社', 'ログイン'].map((label, i) => (
              <div key={label} className="flex items-center gap-2">
                <div className={`w-7 h-7 rounded-full flex items-center justify-center text-xs font-medium transition-colors ${
                  ...
                  i === stepIndex ? 'bg-blue-600 text-white ring-2 ring-blue-300' :
                ...
                {i < 1 && <div className={`w-8 h-0.5 ${i < stepIndex ? 'bg-blue-600' : 'bg-gray-200'}`} />}
              </div>
            ))}
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
            ...
            {tenantName && step !== 'account' && (
              <div className="flex items-center gap-2 mb-5 px-3 py-2 bg-blue-50 rounded-lg border border-blue-100">
                ...
                <span className="text-sm font-medium text-blue-800">{tenantName}</span>
              </div>
            )}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      type="text"
                      value={accountCode}
                      onChange={(e) => setAccountCode(e.target.value.toLowerCase())}
                  ...
                  <p className="text-xs text-gray-400 mt-1.5">管理者から通知された会社アカウントを入力してください</p>
                </div>
